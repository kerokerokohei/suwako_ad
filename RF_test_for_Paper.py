...
def get_df_for_CFT(file_10m,file_20m,year):
      ...
      #このように表記する事で1つのforで同時に複数のリストを回せる
        ...
        #file_2 = os.path.split(j)[1]
        df_oth = pd.read_csv(file_20m,encoding="shift-jis",engine='python',usecols=[4,5,6,7,8,9,10])
        df_oth.columns=["B5(705nm)","B6(740nm)","B7(783nm)","B8A(865nm)","B11(SWIR)",
                    "B12(2190)","CLD"]
        if year >= 2022:
...
# df_2021_07_21_all = get_df_for_CFT("2021_07_21_all_10m.csv","2021_07_21_all_20m.csv",2021)
# df_2021_08_05_all = get_df_for_CFT("2021_08_05_all_10m.csv","2021_08_05_all_20m.csv",2021)
# df_2021_08_30_all = get_df_for_CFT("2021_08_30_all_10m.csv","2021_08_30_all_20m.csv",2021)
# df_2021_09_19_all = get_df_for_CFT("2021_09_19_all_10m.csv","2021_09_19_all_20m.csv",2021)
# df_2021_09_27_all = get_df_for_CFT("2021_09_27_all_10m.csv","2021_09_27_all_20m.csv",2021)
# df_2021_09_29_all = get_df_for_CFT("2021_09_29_all_10m.csv","2021_09_29_all_20m.csv",2021)
# df_2021_10_02_all = get_df_for_CFT("2021_10_02_all_10m.csv","2021_10_02_all_20m.csv",2021)
# df_2021_10_04_all = get_df_for_CFT("2021_10_04_all_10m.csv","2021_10_04_all_20m.csv",2021)

# # df_2021_07_08 = (df_2021_07_21_all + df_2021_08_05_all)/2
# # df_2021_08_all_conc = df_2021_08_05_all #pd.concat([df_2021_08_05_all , df_2021_08_30_all],axis = 0)

# df_geo_2021 = get_geo("2021_10_04_all_10m.csv")
# df_2021_all = df_2021_10_04_all
# df_2021_all = df_2021_all.interpolate()
# df_2021_all = df_2021_all.replace([np.inf,-np.inf],0)
...
# df_result.to_csv("C:\\Users\\kohei\\Desktop\\Analysis_Paper\\result_10_04_ave_from_07_21_08_05_09_27.csv")
